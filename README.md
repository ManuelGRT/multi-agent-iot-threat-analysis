...
| **Clasificador** | Modelo XGBoost multiclase balanceado: identifica uno de 16 tipos de ataque y agrega su familia amplia | Tipo, familia, confianza y top-3; si la confianza es < 0,80, el caso va a revisión |
...
| Clasificador de 16 tipos (test balanceado, n=1.200) | Accuracy 0,8908; macro-F1 0,8917; top-3 0,9800; con umbral 0,80: F1 0,9507 sobre 1.006 decisiones |
